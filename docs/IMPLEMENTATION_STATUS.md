...
latest_afre31_verification = AFRE v3.1 + TradePlan v1 migrated into working tree (UNCOMMITTED): quarantine 155+1 env-skip; kernel 20/20 in repo; host verify PASS; FULL backend 971 passed / 0 failed / 4 skipped (2026-09-07); AFRE-3.0 proofs + BEL do NOT transfer (M5 re-proof required)
latest_d6_verification = D6 M2 shadow adapter complete (repair branch): package vendored 230/230; adapter 14 tests green; spine wiring output-neutral both flag states; FULL backend 1215 passed / 0 failed / 4 skipped (2026-09-07); D6 dormant by default, changes nothing; M3 gates + paper decision NOT started
